...
class ShareItemController: UIViewController {
    ...
    fileprivate func saveToDataBaseWithImageUrl(imageUrl: String) {
        ...
        let values = ["imageUrl": imageUrl, "caption": caption, "imageWidth": postImage.size.width, "imageHeight": postImage.size.height, "creationDate": Date().timeIntervalSince1970] as [String : Any] //most be creationDate
